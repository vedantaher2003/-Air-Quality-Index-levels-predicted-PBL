# Air-Quality-Index-levels-predicted-PBL
a platform which provides users with the predicted Air Quality Index levels of air pollution It also provides some of the statistics observed for AQI related to air pollution.
